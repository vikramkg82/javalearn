...
public class SortedHasMap {
    ...
    public static void main(String[] args) {
        ...
        String string ="Hi hello hello 2 times and hi 2 times Hello total time is not sure";
        HashMap<String,Integer> map = new HashMap<>();
    ...
    public void ConvertHashMaptoList(Map<String,Integer> unsortedmap)
    {
        ...
        list.sort(Map.Entry.comparingByValue()); // sort the map of list ;tried reversed() got error --need  Millan  magic here
